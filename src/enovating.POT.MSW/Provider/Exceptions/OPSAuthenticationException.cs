...
namespace enovating.POT.MSW.Provider.Exceptions
{
    using enovating.POT.MSW.Provider.Abstractions;

    /// <inheritdoc />
    public class OPSAuthenticationException : OPSClientException
    {
        /// <summary>
        ///     Gets the contents of the error.
        /// </summary>
        public IOPSError Content { get; }

        /// <inheritdoc />
        public OPSAuthenticationException(IOPSError error)
            : base(error.ToString())
        {
            Content = error;
        }
