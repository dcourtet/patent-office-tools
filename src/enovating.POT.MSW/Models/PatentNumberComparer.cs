...
namespace enovating.POT.MSW.Models
{
    ...
    /// <inheritdoc />
    public class PatentNumberComparer : IEqualityComparer<PatentNumber>
    {
        /// <inheritdoc />
        public bool Equals(PatentNumber x, PatentNumber y)
        {
            return x != null && y != null && x.ToString() == y.ToString();
        }

        /// <inheritdoc />
        public int GetHashCode(PatentNumber obj)
        {
